...
const BASE_NODES = [
  ...
  },
  {
    ...
    summary: "Delivering client websites for local businesses. Built landing pages for Pelita Clinic and Idaman Sound System.",
    details: [
      "Delivering client websites for local businesses. Built landing pages for Pelita Clinic and Idaman Sound System.",
